...
//JustifiedGalleryAsset::register($this);
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-md-8">
                                                <div class="row" style="margin-bottom: 40px;">
                                                    <div
                                                        class="col-mod-xs-10 col-mod-md-5 vv-info-point-line">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-xs-3">
                                <div class="cm-photo-wrap">
                                    <div class="cm-photo-box"
                                         style="background-image: url('<?= Yii::$app->user->identity->avatar ?>');"></div>
                                </div>
                            </div>
                            <div class="col-xs-9">
                ...
                <div class="modal-footer">
                    <button class="button"><?= Yii::t('app', 'Send') ?></button>
                    <button class="button gray" type="button" data-dismiss="modal"><?= Yii::t('app', 'Cancel') ?></button>
                </div>
    ...
    <div class="modal fade" id="contact-success" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4>Your message was sent to the employer, wait for the answer.</h4>
                </div>
                <div class="modal-footer">
