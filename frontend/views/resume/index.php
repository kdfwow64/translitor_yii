...
?>
<?php $form = \yii\widgets\ActiveForm::begin(['method' => 'get', 'action' => '/resume', 'options' => []]) ?>
<div class="fp-wrapper">
    <div class="fp-wrapper-anim">
        <section class="vl-top" style="background-image: url('<?= Yii::$app->params['resumefoto'] ?>');">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="vl-top-custtext-details">
                            <h2>
                                <?= Yii::$app->params['resumetext'] ?>
                            </h2>
                        </div>
        ...
        <section class="vl-page-content">
            <div class="container">
                <div class="row">
                    <?php if (Yii::$app->keyStorage->get('ads.top_tenants_search_page')) : ?>
                        <div class="col-xs-12" style="margin-bottom: 20px;">
                            <?= Yii::$app->keyStorage->get('ads.top_tenants_search_page')?>
                        </div>
                    <?php endif; ?>
                            ...
                            <div class="mp-cont-wrap">
                                ...
                                if ($vacancies) {
                                    foreach ($vacancies as $vacancy) : ?>
                                        <a href="<?= \yii\helpers\Url::toRoute(['resume/view', 'slug' => $vacancy->slug]) ?>">
                                                    ...
                                                    <div class="col-xs-9">
                                                        <div class="mp-cont-point-maininfo-wrap">
                                                            <div class="mp-cont-point-maininfo">
                                                                ...
                                                                <?php if ($admin) : ?>
                                                                    <button type="button"
                                                                            onclick="window.open('/admin/resume/<?= $vacancy->user_id ?>', '_blank');return false;"
                                                                            target="_blank"
                                                        ...
                                                        <div class="mp-cont-point-subinfo">
                                                            <div class="mp-cont-point-image">
                                                                <?php $c = 0; ?>
                                                                <?php foreach($vacancy->adsAttachments as $image): ?>
                                                                    <?php if ($c != 0): ?>
