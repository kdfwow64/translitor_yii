                                            ...
                                            <div class="row">
                                                <div class="col-mod-md-6 col-mod-xs-10">
                                                    <div class="row">
                                                        <div class="col-xs-12">
                                                            ...
                                                            <div class="crr-price">
                                                                <?= $uservacancy->price ? $uservacancy->price . "<small> " .
                                                                    \Yii::$app->currency->getCurrencyById($uservacancy->currency)['value'] . "</small>" : ''; ?>
                                                            </div>
                                                ...
                                                <div class="col-mod-md-4 col-mod-xs-10">
                                                        ...
                                                        <div class="col-mod-xs-10 col-mod-sm-5">
                                                            <div class="form-group">
                                                                ...
                                                                <?php echo \yii\helpers\Html::activeDropDownList($uservacancy, 'active', [
                                                                    '0' => 'Disabled',
                                                                    '1' => 'Active',
                                                                ], ['class' => 'placeholder_ change-active-button', 'data-id' => $uservacancy->id, 'data-type' => 'vacancy']) ?>
                                                            </div>
                                                        </div>
                                                        <div class="col-mod-xs-10 col-mod-sm-5">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="crr-resume-ctrl">
                                                        ...
                                                        |
                                                        <?= \yii\helpers\Html::a('Edit', ['cabinet/ads-update', 'id' => $uservacancy->id]) ?>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="crr-item-delete-inner">
                                                    ...
                                                    <a href="#">
                                                        <button class="button  delete-submit-record-button"
                                                                ...
                                                                data-id="<?= $uservacancy->id ?>" data-type="vacancy">
                                                            Delete
                                                        </button>
                                                    </a>
                            ...
                            <div class="row slide-wrap crr-add-more">
                                <div class="col-mod-xs-10">
                                    <div class="col-mod-xs-10 col-mod-sm-3">
                                        <?= \yii\helpers\Html::a('Add', ['cabinet/ads-create'], ['class' => 'button gray']) ?>
                                    </div>
                                    <div class="col-mod-xs-10 col-mod-sm-5">
                                        <?php
                                        $error = false;
